...
public class AllSpecCall extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_spec_call);
        specialist = findViewById(R.id.rcv_home_spec_call_specialist);
        back = findViewById(R.id.imv_home_spec_call_back);
        ...
        progressDialog = new ProgressDialog(AllSpecCall.this);
        progressDialog.show();
        progressDialog.setContentView(R.layout.process_dialog);
        specialist.setLayoutManager(new LinearLayoutManager(AllSpecCall.this));
...
//        hospital.addItemDecoration(itemDecoration);
        ...
        Apiservice.apiservice.allspeccall(body).enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    itemNewHomeoneDataRelativeAdapter = new ItemNewHomeoneDataSpecAdapter(AllSpecCall.this ,list);
