...
public class HeraXray extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next = findViewById(R.id.txt_home_home4_imgXray);
        takeXray = findViewById(R.id.btn_home_home4_nextXray);
        imgXray = findViewById(R.id.imv_home_home4_imgXray);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ImagePicker.Companion.with(HeraXray.this)
        ...
        takeXray.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(muir ==null){
                    Toast.makeText(HeraXray.this, "Please input ImageXray", Toast.LENGTH_SHORT).show();
                }else {
                    ...
                    Apiservice.apiservice.xray(body).enqueue(new Callback<ResponseBody>() {
                        @Override
                        public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                            ...
                            try {
                                ...
                                startActivity(new Intent(HeraXray.this, RSXray.class));
                                finish();
